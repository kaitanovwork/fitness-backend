INSERT INTO exercises (id, approach_count, area, muscle_group, name, repeat_count)
VALUES (101, 10, 'ARMS', 'Biceps', 'TestExercise1', 10),
       (102, 12, 'LEGS', 'Legs', 'TestExercise2', 12),
       (103, 8, 'BREAST', 'Triceps', 'TestExercise3', 12),
       (104, 6, 'CHEST', 'Shoulders', 'TestExercise4', 15);
